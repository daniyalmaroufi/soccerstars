...
soccerStars.out: obj/main.o obj/rsdl.o obj/GameManager.o obj/SoccerStars.o
	$(CPP) obj/main.o obj/rsdl.o obj/GameManager.o obj/SoccerStars.o $(RSDL_FLAGS) -o soccerStars.out
